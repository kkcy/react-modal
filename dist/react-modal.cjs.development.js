...
var reactModalStack = require('@mattjennings/react-modal-stack');
var framerMotion = require('framer-motion');
var React = require('react');
var React__default = _interopDefault(React);
var themeUi = require('theme-ui');
var matchMedia = require('@theme-ui/match-media');
var reactScrolllock = require('react-scrolllock');
...
var MotionBox = /*#__PURE__*/framerMotion.motion(themeUi.Box);
function Backdrop(props) {
  ...
  return React__default.createElement(MotionBox, Object.assign({
    "aria-hidden": "true",
...
function AnimatedModalStack(props) {
  return React__default.createElement(reactModalStack.ModalStack, Object.assign({
...
function AnimatedModals(_ref) {
  ...
  var _useState = React.useState(stack),
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(framerMotion.AnimatePresence, null, stack.length > 0 && React__default.createElement(Backdrop, null)), displayedStack.map(function (modal, index) {
    var open = index === displayedStack.length - 1 && isOpen;
    return React__default.createElement(modal.component, Object.assign({
      key: index,
      open: open,
      Backdrop: null,
      onClose: closeModal,
...
var MotionBox$1 = /*#__PURE__*/framerMotion.motion(themeUi.Box);
function Modal(_ref) {
  ...
  var _useModals = reactModalStack.useModals(),
      closeModal = _useModals.closeModal;

  var modalAnimations = React.useMemo(function () {
    return enhanceAnimations(animations);
  }, [animations]);
  var isFullScreen = matchMedia.useResponsiveValue(getBreakpoints(fullScreen));
  var animation = matchMedia.useResponsiveValue([isFullScreen ? modalAnimations.fullScreen : modalAnimations["default"], isFullScreen ? modalAnimations.fullScreen : modalAnimations["default"], modalAnimations["default"]]);
  ...
  return React__default.createElement(ModalContext.Provider, {
    value: contextValue
  }, React__default.createElement(framerMotion.AnimatePresence, {
    custom: {
      skip: skipAnimations
    }
  }, open && React__default.createElement(reactScrolllock.TouchScrollable, null, React__default.createElement(themeUi.Box, {
    sx: {
      zIndex: "modal",
      position: "fixed",
      top: 0,
  ...
  }, BackdropComponent && React__default.createElement(BackdropComponent, null), React__default.createElement(MotionBox$1, Object.assign({
    "aria-modal": "true",
    variants: animation,
    animate: "enter",
    exit: "exit",
...
var ModalContent = /*#__PURE__*/React__default.forwardRef(function ModalContent(props, ref) {
...
var ModalFooter = /*#__PURE__*/React__default.forwardRef(function ModalFooter(props, ref) {
  return React__default.createElement(themeUi.Box, Object.assign({
...
var ModalTitle = /*#__PURE__*/React__default.forwardRef(function ModalTitle(_ref, ref) {
  ...
  return React__default.createElement(themeUi.Box, Object.assign({
    ...
    ref: ref
  }), children, allowClose && (CloseButton ? React__default.createElement(CloseButton, {
    onClick: onClose
  }) : React__default.createElement(themeUi.Close, {
    sx: {
      height: 6,
      width: 6,
      '&:hover': {
...
exports.AnimatedModalStack = AnimatedModalStack;
...
exports.withModalTheme = withModalTheme;
//# sourceMappingURL=react-modal.cjs.development.js.map
